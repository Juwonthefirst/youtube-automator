...
const FileCard = (props: StorageFileInfo) => {
  ...
  return (
    <article className="flex items-center gap-3 bg-white dark:bg-black border-black/20 dark:border-white/20 border-[1.5px] rounded-xl px-3 py-1.5 hover:border-black/80 dark:hover:border-white/80 transition-all duration-200 max-w-fit">
      {/* <Image
      ...
      <div className="flex flex-col flex-1 gap-1">
        <p className="font-medium col-span-3 line-clamp-1 whitespace-nowrap">
          {props.name}
        </p>
